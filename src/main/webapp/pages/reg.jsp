...
<body>
    ...
    <div class="wrap">
        <div class="wpn">
            <div class="form-data pos">
                <a href=""><img src="<%=basePath%>/static/img/logo.png" class="head-logo"></a>
                ...
                <div class="bottom-info">已有账号，<a href="./index">马上登录</a></div>
    ...
    <script src="<%=basePath%>/static/js/reg.js"></script>
</body>
</html>